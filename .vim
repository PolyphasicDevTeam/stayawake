...
map <SNR>25_WS <Plug>AlignMapsWrapperStart
nmap <SNR>25_WE <Plug>AlignMapsWrapperEnd
...
set pyxversion=3
set ruler
set runtimepath=~/.vim,~/.vim/bundle/vim-solarized8,~/.vim/bundle/vimwiki,/usr/share/vim/vimfiles,/usr/share/vim/vim81,/usr/share/vim/vim81/pack/dist/opt/matchit,/usr/share/vim/vimfiles/after,~/.vim/after
set scrolloff=5
set shiftwidth=4
set noshowmode
...
set shortmess=aoO
badd +1 configload.py
badd +1 monitor.py
badd +1 schedule.py
badd +1 stayawake.conf
badd +1 stayawake-conf.py
badd +1 stayawake-gtk.py
badd +1 stayawake-qt.py
badd +1 wakeup.py
badd +1 README.md
argglobal
silent! argdel *
$argadd configload.py
$argadd monitor.py
$argadd schedule.py
$argadd stayawake.conf
$argadd stayawake-conf.py
$argadd stayawake-gtk.py
$argadd stayawake-qt.py
$argadd wakeup.py
$argadd README.md
set stal=2
tabnew
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 144 - ((26 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
144
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 115 - ((26 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
115
